...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = [RJBTabBarController new];
    ...
    NSString *oldeVersion = [[NSUserDefaults standardUserDefaults] valueForKey:@"version"];
    NSLog(@"olderversion --- %@",oldeVersion);

    if (![currentVersion isEqualToString:oldeVersion]) {
          [[NSUserDefaults standardUserDefaults] setValue:currentVersion forKey:@"version"];
        RJBGuidView *guidView = [RJBGuidView getGuidView];
